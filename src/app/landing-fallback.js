(function bootLandingFallback(){
  ...
  document.getElementById("loginNextStepBtn")?.addEventListener("click", () => goToLoginStep(2));
  document.getElementById("loginBackStepBtn")?.addEventListener("click", () => goToLoginStep(1));
