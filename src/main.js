import { createAuthService } from "./services/auth-service.js?v=20260419-ai-teacher1";
import { createProjectService } from "./services/project-service.js?v=20260419-ai-teacher1";
import { createGamificationService } from "./services/gamification-service.js?v=20260419-ai-teacher1";
import { createAssignmentService } from "./services/assignment-service.js?v=20260419-ai-teacher1";
import { bootstrapUpgrade, installVisualPolish } from "./ui/upgrade-controller.js?v=20260419-ai-teacher1";
